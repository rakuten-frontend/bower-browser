(function () {
  ...
  angular.module('bowerBrowser', ['angular-loading-bar'])

    .config(['cfpLoadingBarProvider', function (cfpLoadingBarProvider) {
      cfpLoadingBarProvider.includeSpinner = false;
    }])

    .controller('LibraryController', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {

      var timer;

      // Properties
      $scope.bower = {};
      $scope.log = 'Welcome to bower-browser!\n';
      $scope.components = [];
      $scope.list = [];
      $scope.results = [];
